...
import Sudoku.PartialColoring (PartialColoring(..), from2dArray, rowCoords, colCoords, blockCoords, cliques, adjacentVertices, uncoloredVerticies)
...
testFrom2dArray = do
  let matrix = [[6, 8, 5, 0, 3, 0, 2, 9, 4]
               ...
               ,[1, 9, 0, 0, 7, 0, 4, 6, 0]
               ,[8, 7, 6, 3, 1, 0, 9, 0, 0]]
  let expectedGraph = PartialColoring <<< Map.fromFoldable $ [Tuple (Tuple 0 0) Six
...
testUncoloredVertices = do
  let graph = PartialColoring <<< Map.fromFoldable $ [Tuple (Tuple 0 0) Six
                                                     ,Tuple (Tuple 0 1) Eight
                                                     ,Tuple (Tuple 0 2) Five
                                                     ,Tuple (Tuple 0 4) Three
                                                     ,Tuple (Tuple 0 6) Two
